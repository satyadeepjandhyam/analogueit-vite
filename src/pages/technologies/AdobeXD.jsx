    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <ul>
                    <li>Adobe XD has 3D transforms feature. One can move as well as rotate things in space. One can add the look of depth as well as show the work in outlook. The design, along with the tools, one can experience the speculate.</li>
                    <li>By using Adobe XD one can get to the bottom of delightful design. Components work to press on changes in the designs as well as documents immediately. One would get to use up less time duplicate.</li>
                    <li>Drag to turn a single element into the repeat number in grids</li>
                    <li>One can build designs and layouts without much complexity. One can make adjustments with the help of neat controls and can get back to exploring.</li>
                </ul>
            </div>
            <div className="container">
