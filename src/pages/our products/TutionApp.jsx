...
function TutionApp() {
    return (
        ...
        <div className="container">
            <p>These applications are named as Limousine, Employee Transport, School Bus Management, and so on. Here you can book transportation for school children, software management, tourism, hospitality, etc. Make your journey more memorable by traveling with your known ones by avoiding public transports.</p>
